...
data100_3rd = loadtxt('conservation100_3rd_p2/conservation.out', skiprows=1)
data200_3rd = loadtxt('conservation200_3rd_p2/conservation.out', skiprows=1)
data400_3rd = loadtxt('conservation400_3rd_p2/conservation.out', skiprows=1)
data800_3rd = loadtxt('conservation800_3rd_p2/conservation.out', skiprows=1)

#data100_4th = loadtxt('conservation100_3rd_p5/conservation.out', skiprows=1)
#data200_4th = loadtxt('conservation200_3rd_p5/conservation.out', skiprows=1)
#data400_4th = loadtxt('conservation400_3rd_p5/conservation.out', skiprows=1)
#data800_4th = loadtxt('conservation800_3rd_p5/conservation.out', skiprows=1)
...
figure()
subplot(131)
plot(time100_3rd[1:100], mom100_3rd [1:100] - mom100_3rd [1], 'b-' , label='pres2: dt=10.0')
#plot(time100_4th[1:100], mom100_4th [1:100] - mom100_4th [1], 'r-' , label='pres5: dt=10.0')
plot(time200_3rd[1:200], mom200_3rd [1:200] - mom200_3rd [1], 'b--', label='pres2: dt=5.0')
#plot(time200_4th[1:200], mom200_4th [1:200] - mom200_4th [1], 'r--', label='pres5: dt=5.0')
plot(time400_3rd[1:400], mom400_3rd [1:400] - mom400_3rd [1], 'b:' , label='pres2: dt=2.5')
#plot(time400_4th[1:400], mom400_4th [1:400] - mom400_4th [1], 'r:' , label='pres5: dt=2.5')
plot(time800_3rd[1:800], mom800_3rd [1:800] - mom800_3rd [1], 'b:' , label='pres2: dt=1.25')
#plot(time800_4th[1:800], mom800_4th [1:800] - mom800_4th [1], 'r:' , label='pres5: dt=1.25')
legend(loc=0, frameon=False)
title('momentum conservation')
subplot(132)
plot(time100_3rd[1:100], tke100_3rd [1:100] - tke100_3rd [1], 'b-' , label='pres2: dt=10.0')
#plot(time100_4th[1:100], tke100_4th [1:100] - tke100_4th [1], 'r-' , label='pres5: dt=10.0')
plot(time200_3rd[1:200], tke200_3rd [1:200] - tke200_3rd [1], 'b--', label='pres2: dt=5.0')
#plot(time200_4th[1:200], tke200_4th [1:200] - tke200_4th [1], 'r--', label='pres5: dt=5.0')
plot(time400_3rd[1:400], tke400_3rd [1:400] - tke400_3rd [1], 'b:' , label='pres2: dt=2.5')
#plot(time400_4th[1:400], tke400_4th [1:400] - tke400_4th [1], 'r:' , label='pres5: dt=2.5')
plot(time800_3rd[1:800], tke800_3rd [1:800] - tke800_3rd [1], 'b:' , label='pres2: dt=1.25')
#plot(time800_4th[1:800], tke800_4th [1:800] - tke800_4th [1], 'r:' , label='pres5: dt=1.25')
legend(loc=0, frameon=False)
...
figure()
loglog(dts, abs(tkelosses_3rd), 'bo-', label='pres2')
#loglog(dts, abs(tkelosses_4th), 'go-', label='pres5')
